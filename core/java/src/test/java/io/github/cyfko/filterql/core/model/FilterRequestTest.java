...
class FilterRequestTest {
    ...
    void shouldCreateFilterRequestWithNullCombineWith() {
        // Given
        Map<String, FilterDefinition<DefinedPropertyReference>> filters = new HashMap<>();
        filters.put("filter1", new FilterDefinition<>(DefinedPropertyReference.USER_NAME, Op.EQ, "value"));
    ...
    void shouldHandleComplexFilterScenarios() {
        ...
        filters.put("ageFilter", new FilterDefinition<>(DefinedPropertyReference.USER_AGE, Op.RANGE, new Object[]{18, 65}));
