"""
Setup script for the dynamic-filter-sqlalchemy Python package.
"""
...
setup(
    name="dynamic-filter-sqlalchemy",
    version="1.0.0",
    author="Frank KOSSI",
    author_email="frank.kossi@kunrin.com",
    description="SQLAlchemy adapter for dynamic filtering",
    ...
    keywords="filter dynamic sqlalchemy database orm",
    license="MIT",
    zip_safe=False,
)